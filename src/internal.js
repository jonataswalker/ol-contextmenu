import { CSS_CLASSES, EVENT_TYPE } from './constants';
import { find, addClass, removeClass, getViewportSize, offset } from './helpers/dom';
...
export class Internal {
    ...
    positionContainer(pixel) {
        ...
        // submenus
        const subs = find(`li.${CSS_CLASSES.submenu}>div`, container, true);
        ...
        removeClass(container, CSS_CLASSES.hidden);
    ...
    closeMenu() {
        this.opened = false;
        addClass(this.Base.container, CSS_CLASSES.hidden);
        this.Base.dispatchEvent({
